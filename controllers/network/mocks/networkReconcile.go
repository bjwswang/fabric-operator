...
import (
	...
	networka "github.com/IBM-Blockchain/fabric-operator/pkg/offering/base/network"
	"github.com/IBM-Blockchain/fabric-operator/pkg/offering/common"
)

type NetworkReconcile struct {
	ReconcileStub        func(*v1beta1.Network, networka.Update) (common.Result, error)
	reconcileMutex       sync.RWMutex
	reconcileArgsForCall []struct {
		arg1 *v1beta1.Network
		arg2 networka.Update
	}
...
func (fake *NetworkReconcile) Reconcile(arg1 *v1beta1.Network, arg2 networka.Update) (common.Result, error) {
...
func (fake *NetworkReconcile) ReconcileCallCount() int {
	fake.reconcileMutex.RLock()
	defer fake.reconcileMutex.RUnlock()
	return len(fake.reconcileArgsForCall)
}

func (fake *NetworkReconcile) ReconcileCalls(stub func(*v1beta1.Network, networka.Update) (common.Result, error)) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
	fake.ReconcileStub = stub
}

func (fake *NetworkReconcile) ReconcileArgsForCall(i int) (*v1beta1.Network, networka.Update) {
	fake.reconcileMutex.RLock()
	defer fake.reconcileMutex.RUnlock()
...
func (fake *NetworkReconcile) ReconcileReturns(result1 common.Result, result2 error) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
...
func (fake *NetworkReconcile) ReconcileReturnsOnCall(i int, result1 common.Result, result2 error) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
	fake.ReconcileStub = nil
...
func (fake *NetworkReconcile) Invocations() map[string][][]interface{} {
...
func (fake *NetworkReconcile) recordInvocation(key string, args []interface{}) {
