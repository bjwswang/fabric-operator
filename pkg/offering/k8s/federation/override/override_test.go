...
import (
	...
	"github.com/IBM-Blockchain/fabric-operator/pkg/offering/k8s/federation/override/mocks"
...
var _ = Describe("K8S Federation Overrides", func() {
	...
	BeforeEach(func() {
		...
		mockedBaseOverrider.CreateClusterRoleStub = func(f *current.Federation, cr *rbacv1.ClusterRole) error {
			cr.Name = f.GetName()
		...
		mockedBaseOverrider.CreateClusterRoleBindingStub = func(f *current.Federation, crb *rbacv1.ClusterRoleBinding) error {
			crb.Name = f.GetName()
