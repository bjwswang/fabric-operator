...
var federationsResource = schema.GroupVersionResource{Group: "ibp.com", Version: "", Resource: "federations"}

var federationsKind = schema.GroupVersionKind{Group: "ibp.com", Version: "", Kind: "Federation"}
...
func (c *FakeFederations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Federation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(federationsResource, name), &v1beta1.Federation{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeFederations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FederationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(federationsResource, federationsKind, opts), &v1beta1.FederationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeFederations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(federationsResource, opts))
}
...
func (c *FakeFederations) Create(ctx context.Context, federation *v1beta1.Federation, opts v1.CreateOptions) (result *v1beta1.Federation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(federationsResource, federation), &v1beta1.Federation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Federation), err
...
func (c *FakeFederations) Update(ctx context.Context, federation *v1beta1.Federation, opts v1.UpdateOptions) (result *v1beta1.Federation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(federationsResource, federation), &v1beta1.Federation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Federation), err
...
func (c *FakeFederations) UpdateStatus(ctx context.Context, federation *v1beta1.Federation, opts v1.UpdateOptions) (*v1beta1.Federation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(federationsResource, "status", federation), &v1beta1.Federation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Federation), err
...
func (c *FakeFederations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(federationsResource, name), &v1beta1.Federation{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeFederations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(federationsResource, listOpts)
...
func (c *FakeFederations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Federation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(federationsResource, name, pt, data, subresources...), &v1beta1.Federation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Federation), err
