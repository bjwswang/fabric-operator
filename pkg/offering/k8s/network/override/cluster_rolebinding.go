...
func (o *Override) CreateClusterRoleBinding(instance *current.Network, crb *rbacv1.ClusterRoleBinding) error {
	// No need to override `BaseOverride`
	return o.BaseOverride.CreateClusterRoleBinding(instance, crb)
}

func (o *Override) UpdateClusterRoleBinding(instance *current.Network, crb *rbacv1.ClusterRoleBinding) error {
	// No need to override `BaseOverride`
