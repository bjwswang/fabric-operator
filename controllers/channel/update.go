...
func (r *ReconcileChannel) GetUpdateStatus(instance *current.Channel) *Update {
	return r.GetUpdateStatusAtElement(instance, 0)
}

func (r *ReconcileChannel) GetUpdateStatusAtElement(instance *current.Channel, index int) *Update {
	r.mutex.Lock()
...
func (r *ReconcileChannel) PushUpdate(instance string, update Update) {
	r.mutex.Lock()
	defer r.mutex.Unlock()
...
func (r *ReconcileChannel) PopUpdate(instance string) *Update {
	r.mutex.Lock()
	defer r.mutex.Unlock()
