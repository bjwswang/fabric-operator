...
var channelsResource = schema.GroupVersionResource{Group: "ibp.com", Version: "", Resource: "channels"}

var channelsKind = schema.GroupVersionKind{Group: "ibp.com", Version: "", Kind: "Channel"}
...
func (c *FakeChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Channel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(channelsResource, name), &v1beta1.Channel{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ChannelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(channelsResource, channelsKind, opts), &v1beta1.ChannelList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeChannels) Create(ctx context.Context, channel *v1beta1.Channel, opts v1.CreateOptions) (result *v1beta1.Channel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(channelsResource, channel), &v1beta1.Channel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Channel), err
...
func (c *FakeChannels) Update(ctx context.Context, channel *v1beta1.Channel, opts v1.UpdateOptions) (result *v1beta1.Channel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(channelsResource, channel), &v1beta1.Channel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Channel), err
...
func (c *FakeChannels) UpdateStatus(ctx context.Context, channel *v1beta1.Channel, opts v1.UpdateOptions) (*v1beta1.Channel, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(channelsResource, "status", channel), &v1beta1.Channel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Channel), err
...
func (c *FakeChannels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(channelsResource, name), &v1beta1.Channel{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeChannels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(channelsResource, listOpts)
...
func (c *FakeChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Channel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(channelsResource, name, pt, data, subresources...), &v1beta1.Channel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Channel), err
