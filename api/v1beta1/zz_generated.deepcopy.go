...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChannelPeer) DeepCopyInto(out *ChannelPeer) {
	*out = *in
	out.NamespacedName = in.NamespacedName
	in.JoinedTime.DeepCopyInto(&out.JoinedTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChannelPeer.
func (in *ChannelPeer) DeepCopy() *ChannelPeer {
	if in == nil {
		return nil
	}
	out := new(ChannelPeer)
