...
type BaseOverride struct {
	CreateClusterRoleStub        func(*v1beta1.Federation, *v1.ClusterRole) error
	...
	CreateClusterRoleBindingStub        func(*v1beta1.Federation, *v1.ClusterRoleBinding) error
	...
	UpdateClusterRoleStub        func(*v1beta1.Federation, *v1.ClusterRole) error
	...
	UpdateClusterRoleBindingStub        func(*v1beta1.Federation, *v1.ClusterRoleBinding) error
...
func (fake *BaseOverride) CreateClusterRole(arg1 *v1beta1.Federation, arg2 *v1.ClusterRole) error {
...
func (fake *BaseOverride) CreateClusterRoleCalls(stub func(*v1beta1.Federation, *v1.ClusterRole) error) {
	fake.createClusterRoleMutex.Lock()
	defer fake.createClusterRoleMutex.Unlock()
	fake.CreateClusterRoleStub = stub
}

func (fake *BaseOverride) CreateClusterRoleArgsForCall(i int) (*v1beta1.Federation, *v1.ClusterRole) {
	fake.createClusterRoleMutex.RLock()
	defer fake.createClusterRoleMutex.RUnlock()
...
func (fake *BaseOverride) CreateClusterRoleBinding(arg1 *v1beta1.Federation, arg2 *v1.ClusterRoleBinding) error {
...
func (fake *BaseOverride) CreateClusterRoleBindingCalls(stub func(*v1beta1.Federation, *v1.ClusterRoleBinding) error) {
	fake.createClusterRoleBindingMutex.Lock()
	defer fake.createClusterRoleBindingMutex.Unlock()
	fake.CreateClusterRoleBindingStub = stub
}

func (fake *BaseOverride) CreateClusterRoleBindingArgsForCall(i int) (*v1beta1.Federation, *v1.ClusterRoleBinding) {
	fake.createClusterRoleBindingMutex.RLock()
	defer fake.createClusterRoleBindingMutex.RUnlock()
...
func (fake *BaseOverride) UpdateClusterRole(arg1 *v1beta1.Federation, arg2 *v1.ClusterRole) error {
...
func (fake *BaseOverride) UpdateClusterRoleCalls(stub func(*v1beta1.Federation, *v1.ClusterRole) error) {
	fake.updateClusterRoleMutex.Lock()
	defer fake.updateClusterRoleMutex.Unlock()
	fake.UpdateClusterRoleStub = stub
}

func (fake *BaseOverride) UpdateClusterRoleArgsForCall(i int) (*v1beta1.Federation, *v1.ClusterRole) {
	fake.updateClusterRoleMutex.RLock()
	defer fake.updateClusterRoleMutex.RUnlock()
...
func (fake *BaseOverride) UpdateClusterRoleBinding(arg1 *v1beta1.Federation, arg2 *v1.ClusterRoleBinding) error {
...
func (fake *BaseOverride) UpdateClusterRoleBindingCalls(stub func(*v1beta1.Federation, *v1.ClusterRoleBinding) error) {
	fake.updateClusterRoleBindingMutex.Lock()
	defer fake.updateClusterRoleBindingMutex.Unlock()
	fake.UpdateClusterRoleBindingStub = stub
}

func (fake *BaseOverride) UpdateClusterRoleBindingArgsForCall(i int) (*v1beta1.Federation, *v1.ClusterRoleBinding) {
	fake.updateClusterRoleBindingMutex.RLock()
	defer fake.updateClusterRoleBindingMutex.RUnlock()
