...
func newOrganizations(c *IbpClient) *organizations {
...
func (c *organizations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Organization, err error) {
	result = &v1beta1.Organization{}
	err = c.client.Get().
...
func (c *organizations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.OrganizationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.OrganizationList{}
	err = c.client.Get().
		Resource("organizations").
...
func (c *organizations) Create(ctx context.Context, organization *v1beta1.Organization, opts v1.CreateOptions) (result *v1beta1.Organization, err error) {
	result = &v1beta1.Organization{}
	err = c.client.Post().
		Resource("organizations").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *organizations) Update(ctx context.Context, organization *v1beta1.Organization, opts v1.UpdateOptions) (result *v1beta1.Organization, err error) {
	result = &v1beta1.Organization{}
	err = c.client.Put().
		Resource("organizations").
...
func (c *organizations) UpdateStatus(ctx context.Context, organization *v1beta1.Organization, opts v1.UpdateOptions) (result *v1beta1.Organization, err error) {
	result = &v1beta1.Organization{}
	err = c.client.Put().
		Resource("organizations").
		Name(organization.Name).
...
func (c *organizations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Organization, err error) {
	result = &v1beta1.Organization{}
